...
SOURCE_DIR="/home/huazkjdxmrsgjzdsyshi/whcs-share18/caiyimin/learnamerx/Amrex/projects/BOX3D" # <--- 修改为你希望复制的源目录绝对路径

# 目标目录（最终落地目录名，可不存在，会被创建）
DEST_DIR="/home/huazkjdxmrsgjzdsyshi/whcs-share18/caiyimin/learnamerx/Amrex/projects/amrex_gpu_3d_single_sphere" # <--- 修改为你希望复制到的目标目录绝对路径；避免目录名包含空格，AMReX/GNU make 对空格路径支持不稳定
