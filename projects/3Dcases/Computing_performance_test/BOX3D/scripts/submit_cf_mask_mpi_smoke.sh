...
#DSUB -n box3d_cf_mask_mpi_smoke
#DSUB -A root.huazkjdxmrsgjzdsyshi
#DSUB -q root.default
#DSUB -R cpu=32;mem=49152;gpu=2
#DSUB -N 1
#DSUB -o logs/submit/%J-cf-mask-mpi-smoke.log
#DSUB -e logs/submit/%J-cf-mask-mpi-smoke.log
#DSUB -l cuda122
...
hostfile=/tmp/box3d-cf-mask-mpi-hostfile.$$
