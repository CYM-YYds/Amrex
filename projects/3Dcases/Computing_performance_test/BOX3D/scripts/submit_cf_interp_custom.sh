...
#DSUB -n box3d_cf_interp_custom
#DSUB -A root.huazkjdxmrsgjzdsyshi
#DSUB -q root.default
#DSUB -R cpu=32;mem=49152;gpu=1
#DSUB -N 1
#DSUB -o logs/submit/%J-cf-interp-custom.log
#DSUB -e logs/submit/%J-cf-interp-custom.log
#DSUB -l cuda122
...
HOSTFILE="/tmp/box3d-cf-interp-custom-hostfile.$$"
